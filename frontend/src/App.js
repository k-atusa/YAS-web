...
function App() {
    ...
    async function startWebAuthnRegistration() {
        ...
        try {
            ...
            const msg = err.message || "WebAuthn registration failed";
    ...
    function renderTabContent() {
        ...
        return (_jsxs(_Fragment, { children: [_jsxs("section", { className: "card", children: [_jsx("h2", { children: "Decrypt" }), _jsx("p", { className: "hint", children: "Paste Base64 ciphertext or upload an encrypted binary, then decrypt locally." }), _jsxs("form", { className: "form-vertical", onSubmit: handleDecryptSubmit, children: [_jsx("label", { className: "label", htmlFor: "decrypt-base64", children: "Ciphertext (Base64)" }), _jsx("textarea", { id: "decrypt-base64", placeholder: "Paste Base64-encoded ciphertext...", value: decryptPayloadInput, onChange: (e) => {
                                        ...
                                        setDecryptedResult(null);
                                        setDecryptDetected(null);
                                    }, disabled: decryptBusy }), _jsxs("div", { className: "file-picker", children: [_jsxs("div", { className: isDecryptFileDragActive ? "file-dropzone drag-active" : "file-dropzone", onDragEnter: handleDecryptDragEnter, onDragOver: handleDecryptDragOver, onDragLeave: handleDecryptDragLeave, onDrop: handleDecryptFileDrop, "aria-disabled": decryptBusy, children: [_jsx("input", { id: "decrypt-file", type: "file", onChange: handleDecryptFileChange, disabled: decryptBusy, className: "visually-hidden" }), _jsxs("label", { htmlFor: "decrypt-file", children: [_jsx("div", { className: "drop-graphic", "aria-hidden": "true", children: _jsxs("svg", { width: "40", height: "40", viewBox: "0 0 40 40", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [_jsx("rect", { x: "7", y: "23", width: "26", height: "10", rx: "3", stroke: "#38bdf8", strokeWidth: "1.6", opacity: "0.7" }), _jsx("path", { d: "M20 7v18", stroke: "#38bdf8", strokeWidth: "1.6", strokeLinecap: "round" }), _jsx("path", { d: "M15 18l5 5 5-5", stroke: "#38bdf8", strokeWidth: "1.6", strokeLinecap: "round", strokeLinejoin: "round" })] }) }), _jsx("strong", { children: "Drag & drop encrypted .bin file" }), _jsx("span", { className: "drop-highlight", children: "Drop your encrypted binary here or click to browse." }), _jsx("span", { className: "muted", children: "We parse and decrypt entirely in your browser." })] })] }), decryptPayloadFile && (_jsxs("div", { className: "file-info", children: [_jsxs("div", { children: [_jsx("strong", { children: decryptPayloadFile.name }), _jsxs("p", { className: "muted", children: [formatBytes(decryptPayloadFile.size), " \u00B7 ", decryptPayloadFile.type || "application/octet-stream"] })] }), _jsx("button", { type: "button", className: "secondary button-inline", onClick: () => {
                                                        setDecryptPayloadFile(null);
                                                        setIsDecryptFileDragActive(false);
                                                    }, disabled: decryptBusy, children: "Remove" })] }))] }), decryptDetected && (_jsxs("div", { className: "status info", children: ["Detected mode: ", _jsx("strong", { children: decryptDetected.mode }), decryptDetected.msg && _jsxs(_Fragment, { children: [" \u2014 Public message: ", decryptDetected.msg] })] })), _jsx("label", { className: "label", htmlFor: "decrypt-password", children: "Password (for password-mode)" }), _jsx("input", { id: "decrypt-password", type: "password", value: decryptPassword, onChange: (e) => { setDecryptPassword(e.target.value); setDecryptError(null); }, placeholder: "Enter the encryption password", disabled: decryptBusy }), _jsx("div", { children: storedAccount?.encryptedPrivateKey && isAuthed && webauthnAvailable && (_jsxs("div", { children: [_jsx("label", { className: "label", children: "Unlock stored key with security key" }), _jsx("button", { type: "button", className: "secondary full-width", onClick: handleWebAuthnAuthenticate, disabled: decryptBusy || webauthnAuthBusy, children: webauthnAuthBusy ? "Verifying..." : "🔐 Authenticate with Security Key" }), decryptionToken && (_jsx("p", { className: "hint success-text", children: "\u2713 Security key verified" }))] })) }), _jsx("div", { className: "grid", children: _jsxs("div", { children: [_jsx("label", { className: "label", htmlFor: "decrypt-private-key", children: "Or paste a private key (Base64)" }), _jsx("textarea", { id: "decrypt-private-key", value: decryptPrivateKeyInput, onChange: (e) => {
                                                    setDecryptPrivateKeyInput(e.target.value);
                                                    setDecryptStatus(null);
                                                    setDecryptError(null);
                                                }, placeholder: "Base64-encoded private key", disabled: decryptBusy }), _jsx("p", { className: "hint", children: "If provided, this overrides stored keys and passphrase unlocking." })] }) }), _jsx("label", { className: "label", htmlFor: "decrypt-peer-pubkey", children: "Peer public key (optional, for signature verification)" }), _jsx("textarea", { id: "decrypt-peer-pubkey", value: decryptPeerPublicKey, onChange: (e) => setDecryptPeerPublicKey(e.target.value), placeholder: "Base64-encoded sender's public key (for verifying signatures)", disabled: decryptBusy }), _jsxs("div", { className: "actions", children: [_jsx("button", { type: "submit", disabled: decryptBusy, children: decryptBusy ? "Decrypting..." : "Decrypt" }), _jsx("button", { type: "button", className: "secondary", onClick: resetDecryptForm, disabled: decryptBusy, children: "Reset" })] }), decryptBusy && (_jsxs("div", { className: "progress-row", role: "status", "aria-live": "polite", children: [_jsx("div", { className: "progress-bar", children: _jsx("div", { className: "progress-fill" }) }), _jsx("span", { className: "muted", children: "Decrypting payload..." })] }))] }), decryptStatus && _jsx("div", { className: "status success", children: decryptStatus }), decryptError && _jsx("div", { className: "status error", children: decryptError })] }), decryptedResult && (_jsxs("section", { className: "card", children: [_jsx("h3", { children: "Decryption result" }), renderDecryptedInfo(decryptedResult), decryptedResult.files.length > 0 && (_jsxs("div", { className: "file-list", children: [_jsx("h4", { children: "Extracted files" }), decryptedResult.files.map((f, i) => (_jsxs("div", { className: "file-info", children: [_jsxs("div", { children: [_jsx("strong", { children: f.name }), _jsx("p", { className: "muted", children: formatBytes(f.data.length) })] }), _jsx("button", { type: "button", className: "secondary button-inline", onClick: () => handleDownloadDecryptedFile(f.name, f.data), children: "Download" })] }, i)))] }))] }))] }));
    }
    if (!isAuthed) {
