...
export async function uploadEncryptedFile(token: string, payload: { recipientId?: string; filename: string; encryptedData: string; expiresAt: string; maxDownloads: number }) {
